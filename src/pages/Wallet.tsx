...
import {
  Wallet as WalletIcon, Trophy, TrendingUp, Star, Users,
  PlusCircle, ArrowUpCircle, Info, ChevronRight,
} from 'lucide-react';
...
export const Wallet: React.FC = () => {
  ...
  const balanceItems = [
    ...
    },
    {
      ...
      desc: 'Money you deposited. Withdrawable but NOT usable in games.',
      usable: false,
    },
    {
      label: 'Bonus Balance',
    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6 max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="relative">
          ...
          <p className="text-sm text-gray-400">
            Usable in games: <span className="text-green-400 font-semibold">{formatCurrency(usableBalance)}</span>
          </p>
        </div>
      </motion.div>
      ...
      <motion.div variants={item}>
        ...
        <div className="space-y-3">
          {balanceItems.map(({ label, value, icon: Icon, color, bg, border, desc, usable, note }) => (
            <motion.div
              key={label}
              whileHover={{ x: 2 }}
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-xs text-gray-400 space-y-1">
              <li>• Winning balance is fully usable in games & withdrawable</li>
              <li>• Deposit balance is NOT directly usable in games</li>
